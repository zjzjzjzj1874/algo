...
func Test_minSteps(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "min steps", args: args{n: 5}, want: 5},
		{name: "min steps", args: args{n: 6}, want: 5},
		{name: "min steps", args: args{n: 7}, want: 7},
		{name: "min steps", args: args{n: 8}, want: 6},
		{name: "min steps", args: args{n: 9}, want: 6},
	}
